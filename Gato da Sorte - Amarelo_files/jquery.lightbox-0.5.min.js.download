 ...
 */
(function($){$.fn.lightBox=function(settings){settings=jQuery.extend({maxWidth: null,maxHeight: null,overlayBgColor:'#000',overlayOpacity:0.8,fixedNavigation:false,imageLoading:'../comum/jqlightbox/images_pt/lightbox-ico-loading.gif',imageBtnPrev:'../comum/jqlightbox/images_pt/lightbox-btn-prev.gif',imageBtnNext:'../comum/jqlightbox/images_pt/lightbox-btn-next.gif',imageBtnClose:'../comum/jqlightbox/images_pt/lightbox-btn-close.gif',imageBlank:'../comum/jqlightbox/images_pt/lightbox-blank.gif',containerBorderSize:10,containerResizeSpeed:400,txtImage:'Imagem',txtOf:'de',keyToClose:'x',keyToPrev:'a',keyToNext:'s',imageArray:[],activeImage:0},settings);var jQueryMatchedObj=this;function _initialize(){_start(this,jQueryMatchedObj);return false;}
